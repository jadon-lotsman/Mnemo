...
namespace Mnemo.Shared
{
    public static class ManualMapper
    {
        ...
        public static EntryResponse? MapToDto(VocabularyEntry? entry)
        {
        ...
        public static EntryResponse[] MapToDto(IEnumerable<VocabularyEntry> entries)
        {
            return entries
                .Where(e => e != null)
                .Select(e => MapToDto(e)!)
        ...
        public static VocabularyEntry MapToEntry(CreateEntryRequest dto, int userId)
        {
        ...
        public static void PatchFromDto(VocabularyEntry entry, PatchEntryRequest patchDto)
        {
            // Foreign patch
